...
CREATE TABLE IF NOT EXISTS asmt_score (
  asmt_id smallint NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS item (
  ...
  claim_id mediumint, -- TODO: change this to NOT NULL when we do not need a hack code that creates assmt
  target_id mediumint, -- TODO: change this to NOT NULL  when we do not need a hack code that creates assmt
  natural_id varchar(40) NOT NULL,
  asmt_id smallint NOT NULL,
